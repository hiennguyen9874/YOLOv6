...
def get_args_parser(add_help=True):
    ...
    parser.add_argument(
        "--conf-thres", type=float, default=0.4, help="confidence threshold for inference."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--not-save-img", action="store_true", help="do not save visuallized inference results."
    )
    parser.add_argument(
        "--save-dir", type=str, help="directory to save predictions in. See --save-txt."
    )
